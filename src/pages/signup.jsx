...
function SignUp() {
  ...
  return (
    <div className='rounded-lg max-w-md mt-20 p-4 mx-auto w-11/12 shadow-xl border bg-slate-600  border-gray-200 shadow-black'>
      ...
      <form onSubmit={handleSignUp}>
        ...
        <InputContainer>
          <FormLabel htmlFor='file' title='Profile Image' />
          <FormInput
            value={image}
            name='file'
            id='file'
        ...
        <button
          type='submit'
          className='mt-3 tracking-wider bg-slate-400 hover:bg-orange-400 rounded text-gray-50 text-sm font-medium px-5 py-2 uppercase'>
          Sign Up
        </button>
      </form>
    </div>
