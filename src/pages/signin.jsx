...
function SignIn() {
  ...
  return (
    <div className='rounded-lg max-w-md mt-20 p-4 mx-auto w-11/12 shadow-black   border bg-slate-600  border-gray-200 shadow-xl'>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className='mt-3 flex gap-2 items-center text-sm font-medium'>
          <button
            type='submit'
            className='rounded uppercase tracking-wider hover:bg-orange-400 text-white font-medium px-8 py-2 bg-slate-400'>
            Sign In
          </button>
        </div>
      </form>
